...
function HeaderSub(props) {
  ...
  return (
    <header id='header' className={scroll ? "header on" : "header"}>
      ...
      <div className={isOpen? "wrap_gnb on": "wrap_gnb"}>
        <section className='area_sns'>
          <h2 className='title_login'>SNS 계정으로 로그인</h2>
        ...
        <nav id='gnb' className={isOpen ? "gnb on" : "gnb"}>
          <h2 className='offscreen'>주 메뉴</h2>
          <ul className='list_gnb'>
            ...
            <li className='item_gnb'><a href="#none" onClick={preventAnchor}>고객센터</a></li>
          </ul>
        </nav>
